...
use packages\phpspreadsheet\NamedRange;
use packages\phpspreadsheet\RichText\RichText;
use packages\phpspreadsheet\Shared\CodePage;
use packages\phpspreadsheet\Shared\Date;
use packages\phpspreadsheet\Shared\Escher;
use packages\phpspreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE;
use packages\phpspreadsheet\Shared\File;
use packages\phpspreadsheet\Shared\OLE;
use packages\phpspreadsheet\Shared\OLERead;
...
use packages\phpspreadsheet\Style\Borders;
use packages\phpspreadsheet\Style\Font;
use packages\phpspreadsheet\Style\NumberFormat;
use packages\phpspreadsheet\Style\Protection;
use packages\phpspreadsheet\Style\Style;
use packages\phpspreadsheet\Worksheet\MemoryDrawing;
        ...
        foreach ($this->sheets as $sheet) {
            ...
            foreach ($this->objs as $n => $obj) {
                ...
                if (isset($allSpContainers[$n + 1]) && is_object($allSpContainers[$n + 1])) {
                    ...
                    $width = \packages\phpspreadsheet\Shared\Xls::getDistanceX($this->phpSheet, $startColumn, $startOffsetX, $endColumn, $endOffsetX);
                    $height = \packages\phpspreadsheet\Shared\Xls::getDistanceY($this->phpSheet, $startRow, $startOffsetY, $endRow, $endOffsetY);

                    // calculate offsetX and offsetY of the shape
                    $offsetX = $startOffsetX * \packages\phpspreadsheet\Shared\Xls::sizeCol($this->phpSheet, $startColumn) / 1024;
                    $offsetY = $startOffsetY * \packages\phpspreadsheet\Shared\Xls::sizeRow($this->phpSheet, $startRow) / 256;
