...
namespace packages\phpspreadsheet\Reader\Xlsx;
...
class Chart
{
     ...
     *
     * @return \packages\phpspreadsheet\Chart\Chart
     */
    public static function readChart(SimpleXMLElement $chartElements, $chartName)
    {
        ...
        $chart = new \packages\phpspreadsheet\Chart\Chart($chartName, $title, $legend, $plotArea, $plotVisOnly, $dispBlanksAs, $XaxisLabel, $YaxisLabel);
