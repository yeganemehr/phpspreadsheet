...
use packages\phpspreadsheet\Document\Properties;
use packages\phpspreadsheet\NamedRange;
use packages\phpspreadsheet\Reader\Xlsx\Chart;
use packages\phpspreadsheet\ReferenceHelper;
use packages\phpspreadsheet\RichText\RichText;
use packages\phpspreadsheet\Settings;
use packages\phpspreadsheet\Shared\Date;
use packages\phpspreadsheet\Shared\Drawing;
use packages\phpspreadsheet\Shared\File;
use packages\phpspreadsheet\Shared\Font;
...
use packages\phpspreadsheet\Worksheet\AutoFilter\Column;
                                        ...
                                        if ($xmlDrawing->oneCellAnchor) {
                                            foreach ($xmlDrawing->oneCellAnchor as $oneCellAnchor) {
                                                if ($oneCellAnchor->pic->blipFill) {
                                                    ...
                                                    $objDrawing = new \packages\phpspreadsheet\Worksheet\Drawing();
    ...
    private static function readStyle(Style $docStyle, $style)
    {
        ...
        if (isset($style->font)) {
            ...
            if (isset($style->font->u) && !isset($style->font->u['val'])) {
                $docStyle->getFont()->setUnderline(\packages\phpspreadsheet\Style\Font::UNDERLINE_SINGLE);
                ...
                foreach ($is->r as $run) {
                    if (!isset($run->rPr)) {
                        ...
                        if (isset($run->rPr->u) && !isset($run->rPr->u['val'])) {
                            $objText->getFont()->setUnderline(\packages\phpspreadsheet\Style\Font::UNDERLINE_SINGLE);
