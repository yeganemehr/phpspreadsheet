...
use packages\phpspreadsheet\Reader\Exception as ReaderException;
use packages\phpspreadsheet\Shared\OLE\ChainedBlockStream;
...
class OLE
{
     ...
     * use \packages\phpspreadsheet\Shared\OLE\PPS\File::getStream().
     *
