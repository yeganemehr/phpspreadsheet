...
namespace packages\phpspreadsheet\Shared\OLE\PPS;
...
use packages\phpspreadsheet\Shared\OLE\PPS;
...
class Root extends PPS
{
    ...
    {
        $this->tempDirectory = \packages\phpspreadsheet\Shared\File::sysGetTempDir();
    ...
    /**
     * Saving big data (PPS's with data bigger than \packages\phpspreadsheet\Shared\OLE::OLE_DATA_SIZE_SMALL).
     *
     * @param int $iStBlk
    ...
    /**
     * get small data (PPS's with data smaller than \packages\phpspreadsheet\Shared\OLE::OLE_DATA_SIZE_SMALL).
     *
     * @param array &$raList Reference to array of PPS's
     *
     * @return string
