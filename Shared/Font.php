...
namespace packages\phpspreadsheet\Shared;
...
class Font
{
     ...
     *
     * @param \packages\phpspreadsheet\Style\Font $font Font object
     * @param RichText|string $cellText Text to calculate width
     * @param int $rotation Rotation angle
     * @param null|\packages\phpspreadsheet\Style\Font $defaultFont Font object
     *
     * @return int Column width
     */
    public static function calculateColumnWidth(\packages\phpspreadsheet\Style\Font $font, $cellText = '', $rotation = 0, \packages\phpspreadsheet\Style\Font $defaultFont = null)
    {
     ...
     *
     * @param string $text
     * @param \packages\phpspreadsheet\Style\Font
     * @param int $rotation
     *
     ...
     * @return int
     */
    public static function getTextWidthPixelsExact($text, \packages\phpspreadsheet\Style\Font $font, $rotation = 0)
    {
     ...
     * @param \packages\phpspreadsheet\Style\Font $font
     * @param int $rotation
     *
     * @return int Text width in pixels (no padding added)
     */
    public static function getTextWidthPixelsApprox($columnText, \packages\phpspreadsheet\Style\Font $font, $rotation = 0)
    {
     ...
     *
     * @param \packages\phpspreadsheet\Style\Font $font The workbooks default font
     * @param bool $pPixels true = return column width in pixels, false = return in OOXML units
     *
     * @return mixed Column width
     */
    public static function getDefaultColumnWidthByFont(\packages\phpspreadsheet\Style\Font $font, $pPixels = false)
    {
     ...
     */
    public static function getDefaultRowHeightByFont(\packages\phpspreadsheet\Style\Font $font)
    {
        switch ($font->getName()) {
            case 'Arial':
                switch ($font->getSize()) {
