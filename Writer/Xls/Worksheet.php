...
namespace packages\phpspreadsheet\Writer\Xls;

use packages\phpspreadsheet\Cell\Coordinate;
use packages\phpspreadsheet\Cell\DataType;
use packages\phpspreadsheet\Cell\DataValidation;
use packages\phpspreadsheet\Exception as PhpSpreadsheetException;
use packages\phpspreadsheet\RichText\RichText;
use packages\phpspreadsheet\RichText\Run;
use packages\phpspreadsheet\Shared\StringHelper;
use packages\phpspreadsheet\Shared\Xls;
use packages\phpspreadsheet\Style\Alignment;
use packages\phpspreadsheet\Style\Border;
use packages\phpspreadsheet\Style\Color;
use packages\phpspreadsheet\Style\Conditional;
use packages\phpspreadsheet\Style\Fill;
use packages\phpspreadsheet\Style\Protection;
use packages\phpspreadsheet\Worksheet\PageSetup;
use packages\phpspreadsheet\Worksheet\SheetView;
...
class Worksheet extends BIFFwriter
{
     ...
     * Formula parser.
     *
     * @var \packages\phpspreadsheet\Writer\Xls\Parser
     */
    private $parser;
     ...
     * Sheet object.
     *
     * @var \packages\phpspreadsheet\Worksheet\Worksheet
     */
    public $phpSheet;
     ...
     *
     * @var \packages\phpspreadsheet\Shared\Escher
     */
    private $escher;
     ...
     * @param \packages\phpspreadsheet\Worksheet\Worksheet $phpSheet The worksheet to write
     */
    public function __construct(&$str_total, &$str_unique, &$str_table, &$colors, Parser $parser, $preCalculateFormulas, \packages\phpspreadsheet\Worksheet\Worksheet $phpSheet)
    {
...
//        if ($this->firstColumnIndex > 255) $this->firstColumnIndex = 255;
     ...
     *
     * @see \packages\phpspreadsheet\Writer\Xls\Workbook::storeWorkbook()
     */
    public function close()
    {
        ...
        if (($defaultWidth = $phpSheet->getDefaultColumnDimension()->getWidth()) < 0) {
            $defaultWidth = \packages\phpspreadsheet\Shared\Font::getDefaultColumnWidthByFont($phpSheet->getParent()->getDefaultStyle()->getFont());
        }
    ...
    private function writeBreaks()
    {
        ...
        foreach ($this->phpSheet->getBreaks() as $cell => $breakType) {
            ...
            switch ($breakType) {
                case \packages\phpspreadsheet\Worksheet\Worksheet::BREAK_COLUMN:
                    // Add to list of vertical breaks
                    $vbreaks[] = Coordinate::columnIndexFromString($coordinates[0]) - 1;

                    break;
                case \packages\phpspreadsheet\Worksheet\Worksheet::BREAK_ROW:
                    // Add to list of horizontal breaks
                    $hbreaks[] = $coordinates[1];

                    break;
                case \packages\phpspreadsheet\Worksheet\Worksheet::BREAK_NONE:
                default:
                    // Nothing to do
                    break;
            }
     ...
     * Get Escher object.
     *
     * @return \packages\phpspreadsheet\Shared\Escher
     */
     ...
     * Set Escher object.
     *
     * @param \packages\phpspreadsheet\Shared\Escher $pValue
     */
    public function setEscher(\packages\phpspreadsheet\Shared\Escher $pValue = null)
    {
        $this->escher = $pValue;
    }
    ...
    private function writeCFRule(Conditional $conditional)
    {
        ...
        if ($bFormatFont == 1) {
            ...
            switch ($conditional->getStyle()->getFont()->getUnderline()) {
                case \packages\phpspreadsheet\Style\Font::UNDERLINE_NONE:
                    $dataBlockFont .= pack('C', 0x00);
                    $fontUnderline = 0;

                    break;
                case \packages\phpspreadsheet\Style\Font::UNDERLINE_DOUBLE:
                    $dataBlockFont .= pack('C', 0x02);
                    $fontUnderline = 0;

                    break;
                case \packages\phpspreadsheet\Style\Font::UNDERLINE_DOUBLEACCOUNTING:
                    $dataBlockFont .= pack('C', 0x22);
                    $fontUnderline = 0;

                    break;
                case \packages\phpspreadsheet\Style\Font::UNDERLINE_SINGLE:
                    $dataBlockFont .= pack('C', 0x01);
                    $fontUnderline = 0;

                    break;
                case \packages\phpspreadsheet\Style\Font::UNDERLINE_SINGLEACCOUNTING:
