...
class Workbook extends BIFFwriter
{
     ...
     * XF Writers.
     *
     * @var \packages\phpspreadsheet\Writer\Xls\Xf[]
     */
    private $xfWriters = [];
     ...
     */
    public function addFont(\packages\phpspreadsheet\Style\Font $font)
    {
    ...
    private function writeBoundSheet($sheet, $offset)
    {
        ...
        switch ($sheet->getSheetState()) {
            case \packages\phpspreadsheet\Worksheet\Worksheet::SHEETSTATE_VISIBLE:
                $ss = 0x00;

                break;
            case \packages\phpspreadsheet\Worksheet\Worksheet::SHEETSTATE_HIDDEN:
                $ss = 0x01;

                break;
            case \packages\phpspreadsheet\Worksheet\Worksheet::SHEETSTATE_VERYHIDDEN:
                $ss = 0x02;
