...
use packages\phpspreadsheet\Cell\Cell;
...
use packages\phpspreadsheet\Shared\Font as SharedFont;
...
class Html extends BaseWriter
{
     ...
     *
     * @param Worksheet $pSheet \packages\phpspreadsheet\Worksheet\Worksheet
    ...
    /**
     * Create CSS style (\packages\phpspreadsheet\Style\Alignment).
     *
     * @param Alignment $pStyle \packages\phpspreadsheet\Style\Alignment
     *
     * @return array
     */
    ...
    /**
     * Create CSS style (\packages\phpspreadsheet\Style\Font).
     *
     * @param Font $pStyle
     *
     * @return array
        ...
        foreach ($pValues as $cellAddress) {
            ...
            if ($writeCell) {
                ...
                if (!$this->useInlineCss) {
                    ...
                    //** Necessary redundant code for the sake of \packages\phpspreadsheet\Writer\Pdf **
