...
class Style extends WriterPart
{
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \packages\phpspreadsheet\Style\Style $pStyle Style
     * @param Spreadsheet $spreadsheet Workbook
     *
     * @throws \packages\phpspreadsheet\Writer\Exception
     */
    private function writeCellStyleXf(XMLWriter $objWriter, \packages\phpspreadsheet\Style\Style $pStyle, Spreadsheet $spreadsheet)
    {
        // xf
        $objWriter->startElement('xf');
        $objWriter->writeAttribute('xfId', 0);
     ...
     * @param \packages\phpspreadsheet\Style\Style $pStyle Style
     */
    private function writeCellStyleDxf(XMLWriter $objWriter, \packages\phpspreadsheet\Style\Style $pStyle)
    {
        // dxf
     ...
     * @param Spreadsheet $spreadsheet
     *
     * @return \packages\phpspreadsheet\Style\Style[] All styles in PhpSpreadsheet
     */
    ...
    public function allFills(Spreadsheet $spreadsheet)
    {
        ...
        /** @var \packages\phpspreadsheet\Style\Style $style */
