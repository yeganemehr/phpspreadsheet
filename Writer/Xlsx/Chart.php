...
use packages\phpspreadsheet\Chart\Axis;
use packages\phpspreadsheet\Chart\DataSeries;
use packages\phpspreadsheet\Chart\DataSeriesValues;
use packages\phpspreadsheet\Chart\GridLines;
use packages\phpspreadsheet\Chart\Layout;
use packages\phpspreadsheet\Chart\Legend;
use packages\phpspreadsheet\Chart\PlotArea;
use packages\phpspreadsheet\Chart\Title;
...
class Chart extends WriterPart
{
     ...
     */
    public function writeChart(\packages\phpspreadsheet\Chart\Chart $pChart, $calculateCellValues = true)
    {
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \packages\phpspreadsheet\Worksheet\Worksheet $pSheet
     ...
     * @throws WriterException
     */
    private function writePlotArea(XMLWriter $objWriter, \packages\phpspreadsheet\Worksheet\Worksheet $pSheet, PlotArea $plotArea, Title $xAxisLabel = null, Title $yAxisLabel = null, Axis $xAxis = null, Axis $yAxis = null, GridLines $majorGridlines = null, GridLines $minorGridlines = null)
    {
        if ($plotArea === null) {
            return;
        }
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \packages\phpspreadsheet\Chart\Layout $chartLayout Chart layout
     */
