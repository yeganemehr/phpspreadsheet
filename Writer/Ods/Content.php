...
use packages\phpspreadsheet\Worksheet\Row;
use packages\phpspreadsheet\Worksheet\Worksheet;
use packages\phpspreadsheet\Writer\Exception;
use packages\phpspreadsheet\Writer\Ods;
use packages\phpspreadsheet\Writer\Ods\Cell\Comment;
...
class Content extends WriterPart
{
    ...
    private function writeCells(XMLWriter $objWriter, Row $row)
    {
        ...
        while ($cells->valid()) {
            /** @var \packages\phpspreadsheet\Cell\Cell $cell */
            $cell = $cells->current();
     ...
     * @param Cell $cell
     *
     * @throws \packages\phpspreadsheet\Exception
     */
