...
use packages\phpspreadsheet\Calculation\Engine\CyclicReferenceStack;
use packages\phpspreadsheet\Calculation\Engine\Logger;
use packages\phpspreadsheet\Calculation\Token\Stack;
...
class Calculation
{
    ...
    /**
     * @param string $formula
     * @param null|\packages\phpspreadsheet\Cell\Cell $pCell
     *
     * @return bool
     */
